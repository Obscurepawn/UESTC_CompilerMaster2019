...
init_declarator: declarator {$$ = $1}
               | declarator '=' add_expr {$$ = newAstNode("VariableInit",NULL,0,$1,$2);}
...
direct_declarator: ID {$$ = newAstNode("VariableName",strdup($1),0,NULL,NULL);}
                 ...
                 | ID '[' ']' {$$ = newAstNode("ListDec",strdup($1),NULL,NULL);}
                 ;
...
assign_expr: cmp_expr {$$ = $1;}
           ...
           | ID '[' expr ']' '=' assign_expr {$$ = newAstNode("=","ListEvalue",CreateNewAstNode(strdup($1),"ListRef",NULL,NULL),CreateNewAstNode("","__list__",$3,$6));}
           ;
cmp_expr: add_expr {$$ = $1;}
